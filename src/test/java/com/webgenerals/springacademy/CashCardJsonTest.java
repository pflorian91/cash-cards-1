...
public class CashCardJsonTest {
	...
	public void cashCardSerializationTest() throws IOException {
		...
		File singleJsonFile = new ClassPathResource("example/single.json").getFile();

		assertThat(json.write(cashCard)).isStrictlyEqualToJson(singleJsonFile);
	...
	void cashCardListSerializationTest() throws IOException {
		File listJsonFile = new ClassPathResource("example/list.json").getFile();
		assertThat(jsonList.write(cashCards)).isStrictlyEqualToJson(listJsonFile);
	}
